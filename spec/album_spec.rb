...
describe '#Album' do
  ...
  describe('#save') do
    it("saves an album") do
      ...
      album.save()
      album2 = Album.new({:name => "Blue", :id => nil, :year => 1990, :genre => "pop", :artist => "Aba", :status => true, :cost => 10})
      album2.save()
  ...
  describe('#==') do
    it("is the same album if it has the same attributes as another album") do
      album = Album.new({:name => "Blue", :id => nil, :year => 1990, :genre => "pop", :artist => "Aba", :status => true, :cost => 10})
      album2 = Album.new({:name => "Blue", :id => nil, :year => 1990, :genre => "pop", :artist => "Aba", :status => true, :cost => 10})
  ...
  describe('.clear') do
    it("clears all albums") do
      album = Album.new({:name => "Giant Steps", :id => nil, :year => 2000, :genre => "bluegrass", :artist => "old mcdonald", :id => nil, :status => true, :cost => 10})
      album.save()
      album2 = Album.new({:name => "Blue", :id => nil, :year => 1990, :genre => "pop", :artist => "Aba", :status => true, :cost => 10})
      album2.save()
      Album.clear()
  ...
  describe('#update') do
    it("updates an album by id") do
      album = Album.new({:name => "Giant Steps", :id => nil, :year => 2000, :genre => "bluegrass", :artist => "old mcdonald", :status => true, :cost => 10})
      album.save()
      album.update("A Love Supreme", 2000, "bluegrass", "old mcdonald", 10)
